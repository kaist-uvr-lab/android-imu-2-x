...
import static kr.ac.glass.ui.MotionEventGenerator.DOWN_TIME;
import static kr.ac.glass.ui.MotionEventGenerator.INITIAL_X;
import static kr.ac.glass.ui.MotionEventGenerator.INITIAL_Y;
import static kr.ac.glass.ui.MotionEventGenerator.META_STATE;
import static kr.ac.glass.ui.MotionEventGenerator.SECOND_FINGER_INITIAL_X;
import static kr.ac.glass.ui.MotionEventGenerator.SECOND_FINGER_INITIAL_Y;
import static kr.ac.glass.ui.MotionEventGenerator.getActionCancel;
import static kr.ac.glass.ui.MotionEventGenerator.getActionDown;
import static kr.ac.glass.ui.MotionEventGenerator.getActionMove;
import static kr.ac.glass.ui.MotionEventGenerator.getActionUp;
import static kr.ac.glass.ui.MotionEventGenerator.getSecondFingerActionDown;
import static kr.ac.glass.ui.MotionEventGenerator.getSecondFingerActionMove;
import static kr.ac.glass.ui.MotionEventGenerator.getSecondFingerActionUp;
...
public class GlassGestureDetectorTest {
  ...
  private GlassGestureDetector.Gesture detectedGesture;
  ...
  public void testScrolling() {
    ...
    assertEquals(0, scrollingDistanceX, DELTA);
    assertEquals(TWICE_SWIPE_DISTANCE_THRESHOLD_PX, scrollingDistanceY, DELTA);
    Assert.assertEquals(GlassGestureDetector.Gesture.SWIPE_UP, detectedGesture);
  }
  ...
  public void testTapGesture() {
    ...
    Assert.assertEquals(GlassGestureDetector.Gesture.TAP, detectedGesture);
  }
  ...
  public void testTwoFingerTapGesture() {
    ...
    assertTrue(glassGestureDetector.onTouchEvent(getActionUp(INITIAL_X, INITIAL_Y)));
    Assert.assertEquals(GlassGestureDetector.Gesture.TWO_FINGER_TAP, detectedGesture);
  }
  ...
  public void testAngleSwipeForward() {
    ...
    Assert.assertEquals(GlassGestureDetector.Gesture.SWIPE_FORWARD, detectedGesture);
  ...
  public void testAngleTwoFingerSwipeForward() {
    ...
    assertTrue(glassGestureDetector.onTouchEvent(
        getActionUp(endX, INITIAL_Y - TWICE_SWIPE_DISTANCE_THRESHOLD_PX)));
    Assert.assertEquals(GlassGestureDetector.Gesture.TWO_FINGER_SWIPE_FORWARD, detectedGesture);
  ...
  public void testAngleSwipeBackward() {
    ...
    assertTrue(glassGestureDetector.onTouchEvent(
        getActionUp(endX, INITIAL_Y - TWICE_SWIPE_DISTANCE_THRESHOLD_PX)));
    Assert.assertEquals(GlassGestureDetector.Gesture.SWIPE_BACKWARD, detectedGesture);
  ...
  public void testAngleTwoFingerSwipeBackward() {
    ...
    assertTrue(glassGestureDetector.onTouchEvent(
        getActionUp(endX, INITIAL_Y - TWICE_SWIPE_DISTANCE_THRESHOLD_PX)));
    Assert.assertEquals(GlassGestureDetector.Gesture.TWO_FINGER_SWIPE_BACKWARD, detectedGesture);
  ...
  public void testAngleTwoFingerSwipeUp() {
    ...
    assertTrue(glassGestureDetector.onTouchEvent(
        getActionUp(endX, INITIAL_Y - TWICE_SWIPE_DISTANCE_THRESHOLD_PX)));
    Assert.assertEquals(GlassGestureDetector.Gesture.TWO_FINGER_SWIPE_UP, detectedGesture);
  ...
  public void testAngleSwipeDown() {
    ...
    assertTrue(glassGestureDetector.onTouchEvent(
        getActionUp(endX, INITIAL_Y + TWICE_SWIPE_DISTANCE_THRESHOLD_PX)));
    Assert.assertEquals(GlassGestureDetector.Gesture.SWIPE_DOWN, detectedGesture);
  ...
  public void testAngleTwoFingerSwipeDown() {
    ...
    assertTrue(glassGestureDetector.onTouchEvent(
        getActionUp(endX, INITIAL_Y + TWICE_SWIPE_DISTANCE_THRESHOLD_PX)));
    Assert.assertEquals(GlassGestureDetector.Gesture.TWO_FINGER_SWIPE_DOWN, detectedGesture);
  ...
  private MotionEvent getMotionEventForGesture(GlassGestureDetector.Gesture gesture) {
    int X_CHANGE = 0;
    int Y_CHANGE = 0;
  ...
  class GestureListener implements GlassGestureDetector.OnGestureListener {
